-- Fix column names for PostgreSQL (add quotes for mixed case)

-- Drop existing tables and recreate with proper quoting
...
VALUES ('base_price_bs', '0')
ON CONFLICT ("settingKey") DO NOTHING;

INSERT INTO settings ("settingKey", "settingValue")
VALUES ('base_price_usd', '0')
ON CONFLICT ("settingKey") DO NOTHING;